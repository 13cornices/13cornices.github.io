...
To publish an update, replace the files on the website and change `CACHE_NAME` in `service-worker.js`, for example from `soccer-sub-tracker-v7` to `soccer-sub-tracker-v8`. Phones will pick up the new cache after they open the app online.
